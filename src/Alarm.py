...
class Alarm:
    ...
    def schedule_per_week_day(self):
        """

        :param time: time int for create the alarm
        :return: none
        """
        return Alarm.verify_weekday(self, text="segunda")
...
# Alarm(10)
# Alarm.schedule_per_week_day(self=None)
# Alarm.voice_treatment(self=None, text="Alarme")
